...
def compute_gcl_relevance(text_vecs, edge_index, edge_weights, relevance_map):
    ...
    try:
        ...
        print(text_vecs.shape, edge_index.shape, edge_weights.shape)
...
if __name__ == '__main__':
    ...
    if model == 'BiGCN':
        if version == 2:
            ...
            checkpoint_paths = ['best_BiGCNv2_PHEME_f0_i0_e00033_l1.10273.pt',
                                'best_BiGCNv2_PHEME_f1_i0_e00002_l1.04071.pt',
                                'best_BiGCNv2_PHEME_f2_i0_e00035_l1.00830.pt',
                                'best_BiGCNv2_PHEME_f3_i0_e00003_l1.02930.pt',
                                'best_BiGCNv2_PHEME_f4_i0_e00032_l0.98720.pt',
                                'best_BiGCNv2_PHEME_f5_i0_e00013_l0.99165.pt',
                                'best_BiGCNv2_PHEME_f6_i0_e00007_l0.99139.pt',
                                'best_BiGCNv2_PHEME_f7_i0_e00002_l1.03009.pt',
                                'best_BiGCNv2_PHEME_f8_i0_e00015_l1.01256.pt']
        elif version == 2.1:
            net = BiGCN(768, 64, 64, device).to(device)
            if split_type == '5fold':
                checkpoint_paths = ['best_5fold-BiGCNv2.1_PHEME_f0_i0_e00033_l1.26990.pt',
                                    'best_5fold-BiGCNv2.1_PHEME_f1_i0_e00059_l1.24320.pt',
                                    'best_5fold-BiGCNv2.1_PHEME_f2_i0_e00034_l1.27771.pt',
                                    'best_5fold-BiGCNv2.1_PHEME_f3_i0_e00055_l1.24879.pt',
                                    'best_5fold-BiGCNv2.1_PHEME_f4_i0_e00083_l1.21683.pt']
            elif split_type == '9fold':
                checkpoint_paths = ['best_9fold-BiGCNv2.1_PHEME_f0_i0_e00012_l1.30968.pt',
                                    'best_9fold-BiGCNv2.1_PHEME_f1_i0_e00000_l1.39298.pt',
                                    'best_9fold-BiGCNv2.1_PHEME_f2_i0_e00014_l1.34176.pt',
                                    'best_9fold-BiGCNv2.1_PHEME_f3_i0_e00005_l1.33857.pt',
                                    'best_9fold-BiGCNv2.1_PHEME_f4_i0_e00000_l1.38964.pt',
                                    'best_9fold-BiGCNv2.1_PHEME_f5_i0_e00011_l1.32718.pt',
                                    'best_9fold-BiGCNv2.1_PHEME_f6_i0_e00019_l1.33247.pt',
                                    'best_9fold-BiGCNv2.1_PHEME_f7_i0_e00018_l1.30714.pt',
                                    'best_9fold-BiGCNv2.1_PHEME_f8_i0_e00012_l1.32556.pt']
        else:
        ...
        if version == 2:
            ...
            checkpoint_paths = ['best_EBGCNv2_PHEME_f0_i0_e00002_l1.04426.pt',
                                'best_EBGCNv2_PHEME_f1_i0_e00005_l0.89505.pt',
                                'best_EBGCNv2_PHEME_f2_i0_e00001_l0.99790.pt',
                                'best_EBGCNv2_PHEME_f3_i0_e00001_l0.93692.pt',
                                'best_EBGCNv2_PHEME_f4_i0_e00000_l1.06813.pt',
                                'best_EBGCNv2_PHEME_f5_i0_e00005_l0.85202.pt',
                                'best_EBGCNv2_PHEME_f6_i0_e00000_l0.98931.pt',
                                'best_EBGCNv2_PHEME_f7_i0_e00000_l1.01297.pt',
                                'best_EBGCNv2_PHEME_f8_i0_e00001_l0.94706.pt']
        elif version == 2.1:
            args.input_features = 768
            if split_type == '5fold':
                checkpoint_paths = ['best_5fold-EBGCNv2.1_PHEME_f0_i0_e00018_l0.79087.pt',
                                    'best_5fold-EBGCNv2.1_PHEME_f1_i0_e00005_l1.04033.pt',
                                    'best_5fold-EBGCNv2.1_PHEME_f2_i0_e00018_l0.83972.pt',
                                    'best_5fold-EBGCNv2.1_PHEME_f3_i0_e00011_l0.94436.pt',
                                    'best_5fold-EBGCNv2.1_PHEME_f4_i0_e00008_l0.98498.pt']
            elif split_type == '9fold':
                checkpoint_paths = ['best_9fold-EBGCNv2.1_PHEME_f0_i0_e00002_lnan.pt',
                                    'best_9fold-EBGCNv2.1_PHEME_f1_i0_e00013_l0.90261.pt',
                                    'best_9fold-EBGCNv2.1_PHEME_f2_i0_e00003_lnan.pt',
                                    'best_9fold-EBGCNv2.1_PHEME_f3_i0_e00001_l1.19922.pt',
                                    'best_9fold-EBGCNv2.1_PHEME_f4_i0_e00000_l1.28496.pt',
                                    'best_9fold-EBGCNv2.1_PHEME_f5_i0_e00007_l1.00192.pt',
                                    'best_9fold-EBGCNv2.1_PHEME_f6_i0_e00004_l1.12505.pt',
                                    'best_9fold-EBGCNv2.1_PHEME_f7_i0_e00003_l1.12117.pt',
                                    'best_9fold-EBGCNv2.1_PHEME_f8_i0_e00000_l1.30013.pt']
        else:
        ...
        net = TreeBERT(256 * 768, 64, 64, device, pooling, version).to(device)
        if pooling == 'max':
            ...
            checkpoint_paths = ['best_maxBERT_PHEME_f0_i0_e00003_l1.18108.pt',
                                'best_maxBERT_PHEME_f1_i0_e00003_l1.08792.pt',
                                'best_maxBERT_PHEME_f2_i0_e00016_l1.11006.pt',
                                'best_maxBERT_PHEME_f3_i0_e00004_l1.07615.pt',
                                'best_maxBERT_PHEME_f4_i0_e00010_l1.08778.pt',
                                'best_maxBERT_PHEME_f5_i0_e00001_l1.04515.pt',
                                'best_maxBERT_PHEME_f6_i0_e00001_l1.03695.pt',
                                'best_maxBERT_PHEME_f7_i0_e00014_l1.07558.pt',
                                'best_maxBERT_PHEME_f8_i0_e00010_l1.07006.pt']
        elif pooling == 'mean':
            ...
            checkpoint_paths = ['best_meanBERT_PHEME_f0_i0_e00008_l1.16981.pt',
                                'best_meanBERT_PHEME_f1_i0_e00001_l1.08510.pt',
                                'best_meanBERT_PHEME_f2_i0_e00001_l1.10744.pt',
                                'best_meanBERT_PHEME_f3_i0_e00004_l1.06819.pt',
                                'best_meanBERT_PHEME_f4_i0_e00009_l1.08176.pt',
                                'best_meanBERT_PHEME_f5_i0_e00000_l1.05618.pt',
                                'best_meanBERT_PHEME_f6_i0_e00001_l1.02497.pt',
                                'best_meanBERT_PHEME_f7_i0_e00011_l1.08564.pt',
                                'best_meanBERT_PHEME_f8_i0_e00003_l1.09157.pt']
    ...
    if config_type == 'original':
        ...
        if split_type == '5fold':
            for fold_num, fold in enumerate(load5foldDataStratified(datasetname)):
                if fold_num != 0:  # Deal with MemoryError
                    continue
                ...
                evaluation_log_path = os.path.join(EXPLAIN_DIR,
                                                   f'{datasetname}_{event_name}_{model0}_original_eval.txt')
                eval_log_string = ''
                ...
                for sample_num, (data_sample, root_tweetid) in enumerate(tqdm(test_loader)):
                    ...
                    if model == 'BiGCN':
                        ...
                        for target in range(4):
                            ...
                            with torch.enable_grad():
                                ...
                                for key, val in model_copy.saved_rels.items():
                                    explain_output[f'lrp_class{target}_{key}'] = val.tolist()
                                # print(model_copy.saved_rels)
                            ...
                            # print(temp_output, torch.exp(temp_output), relevance_all_classes,
                            #       relevance_all_classes.shape)
                            # raise Exception
                        ...
                        x = data_sample.x
                        # TD
                        td_gcn_explanations = extract_intermediates_ebgcn(net.TDrumorGCN, x, edge_index,
                                                                          data_sample, device)
                        explain_output['td_gcn_explanations'] = td_gcn_explanations
                        # BU
                        bu_gcn_explanations = extract_intermediates_ebgcn(net.BUrumorGCN, x, BU_edge_index,
                                                                          data_sample, device)
                        explain_output['bu_gcn_explanations'] = bu_gcn_explanations
                        ...
                        cls = data_sample.x[0, :768]
                        x = x.reshape(x.shape[0], -1, 768)
                        temp_x = torch.zeros((1, x.shape[0] + 1, 768))
                        if 2 <= version <= 3:
                            new_x = data_sample.cls
                        else:
                            if pooling == 'max':
                        ...
                        temp_x[0, 0] = cls
                        temp_x[0, 1:] = new_x
                        new_x = temp_x.to(device)
                        bert_out = net.BERT(inputs_embeds=new_x, output_attentions=True)
                        bert_last_hidden = bert_out.last_hidden_state.squeeze(0)[1:]
                        ...
                        bert_attentions = torch.zeros(len(temp), temp[0].shape[1], x.shape[0], x.shape[0]).to(
                            device)
                        for layer_num, layer in enumerate(temp):
                            bert_attentions[layer_num] = layer.squeeze(0)[:, 1:, 1:]
                        for attention_head in range(bert_attentions.shape[1]):
                            attentions_sum = bert_attentions[:, attention_head].sum(-2).sum(0)
                            # final_layer_attentions = bert_attentions[-1, attention_head].sum(-2)
                            # print(attentions_sum, final_layer_attentions)
                            attentions_sum_top_k = torch.topk(attentions_sum, k=attentions_sum.shape[0])
                            explain_output[f'attention_head_{attention_head}'] = [
                                attentions_sum_top_k.indices.tolist(),
                                attentions_sum_top_k.values.tolist()]
                        bert_attentions_sum = bert_attentions.sum(-2).sum(0).sum(0)
                        bert_attentions_sum_top_k = torch.topk(bert_attentions_sum, k=bert_attentions_sum.shape[0])
                        explain_output['bert_attentions_sum_top_k'] = [bert_attentions_sum_top_k.indices.tolist(),
                                                                       bert_attentions_sum_top_k.values.tolist()]
                        out_labels = net(x, cls)
                    ...
                    if save:
                        with open(os.path.join(EXPLAIN_DIR, datasetname, event_name,
                                               f'{root_tweetid[0]}_{model0}_original_explain.json'), 'w') as f:
            ...
            for fold_num, (fold_train, fold_test) in enumerate(load9foldData(datasetname)):
                ...
                for sample_num, (data_sample, root_tweetid) in enumerate(tqdm(test_loader)):
                    ...
                    explain_output['ground_truth'] = data_sample.y.item()
                    explain_output['correct_prediction'] = correct
                    # print(list(explain_output.keys()))
                    if exp_method == 'lrp':
                    ...
                    if save:
                        save_path = os.path.join(SAVE_DIR_PATH, event_name,
                                                 f'{root_tweetid[0]}_{model0}_original_explain.json')
                ...
                if save:
                    with open(evaluation_log_path, 'w') as f:
                        f.write(eval_log_string)
                    print(f'Eval log saved to {evaluation_log_path}')
        ...
        for randomise in randomise_types:
            ...
            if split_type == '5fold':
                for fold_num, fold in enumerate(load5foldDataStratified(datasetname)):
                    ...
                    test_loader = DataLoader(testdata_list, batch_size=batchsize, shuffle=False, num_workers=5)
                    evaluation_log_path = os.path.join(EXPLAIN_DIR,
                                                       f'{datasetname}_{event_name}_{model0}_n{randomise}_eval.txt')
                    eval_log_string = ''
                    conf_mat = np.zeros((4, 4))
                    for sample_num, (data_sample, root_tweetid) in enumerate(tqdm(test_loader)):
                        explain_output = {}
                        ...
                        if model == 'BiGCN':
                            ...
                            explain_output['bert_last_hidden_sum_top_k'] = [bert_last_hidden_sum_top_k.indices.tolist(),
                                                                            bert_last_hidden_sum_top_k.values.tolist()]
                            temp = bert_out.attentions
                            bert_attentions = torch.zeros(len(temp), temp[0].shape[1], x.shape[0], x.shape[0]).to(device)
                            for layer_num, layer in enumerate(temp):
                                bert_attentions[layer_num] = layer.squeeze(0)[:, 1:, 1:]
                            for attention_head in range(bert_attentions.shape[1]):
                                attentions_sum = bert_attentions[:, attention_head].sum(-2).sum(0)
                                ...
                                # print(attentions_sum, final_layer_attentions)
                                attentions_sum_top_k = torch.topk(attentions_sum, k=attentions_sum.shape[0])
                                explain_output[f'attention_head_{attention_head}'] = [attentions_sum_top_k.indices.tolist(),
                                                                                      attentions_sum_top_k.values.tolist()]
                            bert_attentions_sum = bert_attentions.sum(-2).sum(0).sum(0)
                            bert_attentions_sum_top_k = torch.topk(bert_attentions_sum, k=bert_attentions_sum.shape[0])
                            explain_output['bert_attentions_sum_top_k'] = [bert_attentions_sum_top_k.indices.tolist(),
                        ...
                        if save:
                            with open(os.path.join(EXPLAIN_DIR, datasetname, event_name,
                                                   f'{root_tweetid[0]}_{model0}_n{randomise}_explain.json'), 'w') as f:
                                json.dump(explain_output, f, indent=1)
                        # raise Exception
                    # break
                    outputs.append(fold_output)
                ...
                for fold_num, (fold_train, fold_test) in enumerate(load9foldData(datasetname)):
                    ...
                    for sample_num, (data_sample, root_tweetid) in enumerate(tqdm(test_loader)):
                        ...
                        x = data_sample.x
                        if randomise == 1.0:
                            indices = random.Random(0).sample(range(x.shape[0]), x.shape[0])
                            x = swap_elements(x, range(x.shape[0]), indices)
                            explain_output['swapped_nodes'] = [list(range(x.shape[0])), indices]
                        elif randomise != 0.0:
                            sample_len = int(x.shape[0] * randomise // 1)
                            if sample_len % 2 != 0 and sample_len > 1 and x.shape[0] > 1:
                                sample_len -= 1
                            indices = random.Random(0).sample(range(x.shape[0]), sample_len)
                            # print(indices[:int(sample_len/2)], indices[int(sample_len/2):])
                            x = swap_elements(x, indices[:int(sample_len/2)], indices[int(sample_len/2):])
                            explain_output['swapped_nodes'] = [indices[:int(sample_len/2)], indices[int(sample_len/2):]]
                        data_sample.x = x
        ...
        for drop_edges in drop_edge_types:
            ...
            if split_type == '5fold':
                for fold_num, fold in enumerate(load5foldDataStratified(datasetname)):
                    ...
                    test_loader = DataLoader(testdata_list, batch_size=batchsize, shuffle=False, num_workers=5)
                    evaluation_log_path = os.path.join(EXPLAIN_DIR,
                                                       f'{datasetname}_{event_name}_{model0}_d{drop_edges}_eval.txt')
                    eval_log_string = ''
                    conf_mat = np.zeros((4, 4))
                    for sample_num, (data_sample, root_tweetid) in enumerate(tqdm(test_loader)):
                        ...
                        if save:
                                with open(os.path.join(EXPLAIN_DIR, datasetname, event_name,
                                                       f'{root_tweetid[0]}_{model0}_d{drop_edges}_explain.json'), 'w') as f:
                                    json.dump(explain_output, f, indent=1)
                    outputs.append(fold_output)
                    total_evaluated = conf_mat.sum()
                    total_correct = conf_mat.diagonal().sum()
                ...
                for fold_num, (fold_train, fold_test) in enumerate(load9foldData(datasetname)):
                    # if fold_num != 8:  # Deal with MemoryError
                    #     continue
                    fold_train, fold_train_labels = fold_train
                    fold_test, fold_test_labels = fold_test
                    net = reinit_net()
                    ...
                    for sample_num, (data_sample, root_tweetid) in enumerate(tqdm(test_loader)):
                        ...
                        if save:
                            save_path = os.path.join(SAVE_DIR_PATH, event_name,
                                                     f'{root_tweetid[0]}_{model0}_d{drop_edges}_explain.json')
                            # print(f'Saving to {save_path}')
                            try:
                                with open(save_path, 'w') as f:
                                    json.dump(explain_output, f, indent=1)
        ...
        for weight in set_initial_weight_types:
            ...
            if split_type == '5fold':
                for fold_num, fold in enumerate(load5foldDataStratified(datasetname)):
                    ...
                    test_loader = DataLoader(testdata_list, batch_size=batchsize, shuffle=False, num_workers=5)
                    evaluation_log_path = os.path.join(EXPLAIN_DIR,
                                                       f'{datasetname}_{event_name}_{model0}_w{weight}_eval.txt')
                    eval_log_string = ''
                    conf_mat = np.zeros((4, 4))
                    for sample_num, (data_sample, root_tweetid) in enumerate(tqdm(test_loader)):
                        explain_output = {}
                        ...
                        edge_index = data_sample.edge_index
                        BU_edge_index = data_sample.BU_edge_index
                        edge_weights = torch.ones_like(edge_index[0]).long() * set_initial_weight_types[0]
                        ...
                        if save:
                            with open(os.path.join(EXPLAIN_DIR, datasetname, event_name,
                                                   f'{root_tweetid[0]}_{model0}_w{weight}_explain.json'),
                                      'w') as f:
                                json.dump(explain_output, f, indent=1)
                    outputs.append(fold_output)
                    total_evaluated = conf_mat.sum()
